...
for console in consoles:
    for genre in genres:
        ...
        url += "&ownership=Both&showmultiplat=Yes&results=10&order=TotalSales&showtotalsales=0&showtotalsales=1"
        ...
        table = soup.find_all(id='generalBody')
        rows = table[0].find_all('tr')[3:-1]
